<?php
class ControllerModuleRmfilter extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('module/rm_filter');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('rm_filter', $this->request->post);
		...
		$this->response->setOutput($this->load->view('module/rm_filter.tpl', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/rm_filter')) {
