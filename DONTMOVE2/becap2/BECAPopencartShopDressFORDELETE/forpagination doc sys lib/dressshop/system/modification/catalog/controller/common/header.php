...
class ControllerCommonHeader extends Controller {
	public function index() {
        ...
        $data['week_sale_href'] = $this->url->link('product/category', 'path=1'); // Недельная распродажа
        $data['search_mobile'] = $this->load->controller('common/search/mobile');
        //menu
        $data['top_menu'] = $this->load->controller('module/zmenu/generate', 40);
        $data['category_items'] = $this->load->controller('module/zmenu/generate', 41);
		...
		foreach ($categories as $category) {
			if ($category['top']) {
				...
				'mfp_disabled' => true
                                        ...
                                        //level3
                                        $childs3 = $this->model_catalog_category->getCategories($child['category_id']);
