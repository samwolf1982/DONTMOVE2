...
class ControllerCommonCart extends Controller {
	public function index() {
        ...
        $data['text_cart_items'] = sprintf($this->language->get('text_cart_items'), $this->cart->countProducts() + (isset($this->session->data['vouchers']) ? count($this->session->data['vouchers']) : 0));
        $data['text_cart_total'] = sprintf($this->language->get('text_cart_total'), $this->currency->format($total));
		...
		$data['total_quantity'] = $total_product_quantity;
