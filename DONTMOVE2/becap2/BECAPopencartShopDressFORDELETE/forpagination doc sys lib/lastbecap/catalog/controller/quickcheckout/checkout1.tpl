...
<div class="wrapper">
    ...
    <div class="breadСrumbs">
        < <a href="<?=$_SERVER['HTTP_REFERER']?>">Назад к списку товаров</a>
    </div>
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?> basketCart"><?php echo $content_top; ?>
	  ...
	  <div class="quickcheckoutleft">
		<?php if (!$logged) { ?>
                Укажите данные или войдите в личный кабинет, если Вы ранее регистрировались.
		<div id="payment-address" style="width: 50%;float: left;">
	  ...
	  <?php if (!$logged && $login_module) { ?>
          <div class="quickcheckoutmid" id="login-box" style="width: 50%;float: left;">
		<div id="checkout">
...
function validateTerms() {
	$.ajax({
		...
		type: 'post',
		data: $('#terms input[type=\'checkbox\']:checked') + $('#comment'),
		dataType: 'json',
		cache: false,
		success: function(json) {
			if (json['redirect']) {
