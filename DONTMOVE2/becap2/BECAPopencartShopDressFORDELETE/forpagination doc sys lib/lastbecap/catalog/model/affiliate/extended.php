...
/*--------------------------------------------------
 ...
 | Copyright (c) 2004-2013 Fabr?cio Seger Kolling
...
function get_client_ip() {
	...
	// proxy transparente n?o esconde o IP local, colocando ele ap?s o IP da rede, separado por v?rgula
...
function et($tag){
	...
	$de2['ChkVer'] = '?berpr?fe neuer Version';
	...
	$cat['DestEqOrig'] = 'L`origen i el dest? s?n iguals';
	...
	$cat['ReadDenied'] = 'Acc?s de lectura denegat';
	...
	$cat['SpaceLimReached'] = 'L?mit d`espaci al disc assolit';
	...
	$cat['ChkVerNotAvailable'] = 'La vostra versi? ?s la m?s recent.';
