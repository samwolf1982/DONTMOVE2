  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="buttons clearfix">
        <div class="pull-left"><a href="<?php echo $back; ?>" class=""><?php echo $button_back; ?></a></div>
        <div class="pull-right"><a href="<?php echo $add; ?>" style="margin-right: 10px;"><?php echo $button_new_address; ?></a></div>
      </div>
