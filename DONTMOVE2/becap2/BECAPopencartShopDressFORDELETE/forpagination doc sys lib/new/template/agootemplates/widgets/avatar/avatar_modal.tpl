	...
	<?php  } ?>
		...
		avatarload = function() {
			 ...
			 $.ajax({
			            ...
			            async: 'false',
			            beforeSend: function () {
			              $('#avatar_widget-<?php echo $cmswidget; ?>').html('<?php echo $language->get('text_loading'); ?>...<img src="catalog/view/theme/default/image/aloading16.png" class="loading" style="padding-left: 5px;" />');
			            },
