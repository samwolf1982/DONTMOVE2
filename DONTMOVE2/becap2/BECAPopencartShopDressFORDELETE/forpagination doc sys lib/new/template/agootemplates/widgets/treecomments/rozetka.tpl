	...
	<div class="container_reviews cmswidget" id="<?php echo $prefix;?>container_reviews_<?php echo $mark;?>_<?php echo $mark_id;?>">
		...
		<div id="<?php echo $prefix;?>div_comment_<?php echo $mark_id; ?>" >
			...
			<div id="<?php echo $prefix;?>comment-title">
                            <a href="#"  id="<?php echo $prefix;?>comment_id_reply_0" data-cmswidget="<?php echo $cmswidget; ?>" class="comment_reply comment_buttons form_reply" style="display: none;">
			...
			<div id="<?php echo $prefix;?>reply_comments" style="display:none">
				<div id="<?php echo $prefix;?>comment_work_" class="<?php echo $prefix;?>form_customer_pointer width100 margintop10">
					...
					<?php } ?>
					<form id="<?php echo $prefix;?>form_work_" class="formFAQ">
                                                <p class="titleFormFAQ">Форма СВЯЗИ</p>
						...
						<br>
                                                    <input type="text" name="name" placeholder="Имя" required class="faqinput">
													<input type="email" name="af[email_comment]" placeholder="Email" required class="faqinput" style="float: right;">
						...
						<?php  if (isset($settings_widget['comment_must']) && $settings_widget['comment_must'])   {   ?>
							<div class="ascp_bbode">
                                                            <textarea name="text" id="<?php echo $prefix;?>editor_" class="blog-record-textarea <?php echo $prefix;?>editor blog-textarea_height" placeholder="Вопрос"></textarea>
							</div>
						...
						<?php } else { ?>
				   			<div class="buttons" style="width: 50%; float: right;">
				                <button type="button" id="<?php echo $prefix;?>button-comment-0" data-loading-text="" class="button button-comment submitButtonFaq"><i class="fa fa-pencil-square-o"></i> ОТПРАВИТЬ ВОПРОС</button>
				             </div>
						<?php } ?>
