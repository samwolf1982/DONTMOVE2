...
<script type="text/javascript">
            <?php echo htmlspecialchars_decode($settings['javascript']); ?>	</script>
<?php } ?>
...
<button class="buttonMobileFilter">ФИЛЬТРЫ</button>
<div class="filter category_for_catalog" id="mfilter-box-<?php echo (int) $_idx; ?>">
    <?php if( $heading_title && 1 == 2 ) { ?>
    <p class="textFilter"><?php echo $heading_title; ?></p>
    <?php } ?>
        ...
        <ul>
            <li>
                <div class="mfilter-heading  mfilter-collapsed">
                    <div class="mfilter-heading-content">
                        <div class="mfilter-heading-text"><span>Сортировать по цене</span></div>
                    ...
                    <div class="mfilter-opts-container">
                        <div class="mfilter-content-wrapper">
                            <div class="mfilter-options">
								<div class="mfilter-option mfilter-category">
									<div class="mfilter-tb">
										<?php foreach($sorts as $_sort) { ?>
										<div class="mfilter-option mfilter-option-collapsed mfilter-tb-as-tr <?php if ($_sort['value'] == $sort . '-' . $order) echo ' menu-item_checked'; ?>">
											<div class="mfilter-tb-as-td mfilter-col-input"></div>
											<label class="mfilter-tb-as-td"><a href="<?php echo $_sort['href']; ?>" class="mf-sorts" style="display:block"><?php echo $_sort['text']; ?></a></label>
											<div class="mfilter-tb-as-td mfilter-col-count"></div>
										</div>
										<?php } ?>
									</div>
                            </div>
			...
			<li>
				<div class="mfilter-heading  mfilter-collapsed">
					<div class="mfilter-heading-content">
						<div class="mfilter-heading-text"><span>Я ищу...</span></div>
						<i class="mfilter-head-icon"></i>
					</div>
				</div>
				<div class="mfilter-content-opts" style="display:none" >
							...
							<div class="mfilter-options">
								<div class="mfilter-tb">
										<?php foreach($categories as $category) { ?>
											<div class="mfilter-option mfilter-option-collapsed mfilter-tb-as-tr <?php if ($category['selected']) echo ' menu-item_checked'; ?>">
												<div class="mfilter-tb-as-td mfilter-col-input"></div>
                                                                                                <a href="<?php echo $category['href']; ?>" style="display:block"><label class="mfilter-tb-as-td "><?php echo $category['name']; ?></label></a>
												<div class="mfilter-tb-as-td mfilter-col-count"></div>
											</div>
										<?php } ?>
            ...
            <li
                ...
                >
					...
					<?php if( in_array( $filter['type'], array( 'image_list_radio', 'image_list_checkbox' ) ) ) { ?>
						<?php
						...
						<div class="mfilter-options mfilter-colors">
							<div class="mfilter-options-container">
								<?php
									$options_tmp = array();
									$total_options = count($filter['options']);
									$i = 0;
									$k = 0;
								?>
								<?php foreach( $filter['options'] as $option_id => $option ) { if( isset( $options_tmp[$option['key']] ) ) continue; $options_tmp[$option['key']] = true; ?>
									<?php
										$open_tag = $i == 0;
										$close_tag = $i == 1 || ($k + 1) >= $total_options;
									?>
									<?php if($open_tag) { ?>
										<div class="tr-cell">
									<?php } ?>
									...
									<div class="mfilter-option mfilter-option-collapsed">
										<div class="mfilter-tb-as-td mfilter-col-input">
											<input data-tt="<?php echo $_tmp_type; ?>"
            							...
            							<div class="mfilter-content-wrapper">
            								<div class="mfilter-options">
            									...
            									<?php } else if( in_array( $filter['type'], array( 'stock_status', 'manufacturers', 'checkbox', 'radio', 'image_list_radio', 'image_list_checkbox' ) ) ) { ?>
            										...
            										<div class="mfilter-options-container">
            											<div class="mfilter-tb">
															<div class="mfilter-option mfilter-option-collapsed mfilter-visible mfilter-tb-as-tr">
            													<div class="mfilter-tb-as-td mfilter-col-input">
            														<input id="mfilter" type="checkbox" value="">
            													</div>
            													<label class="mfilter-tb-as-td menu-item_has-clear_cross reset-filter" for="mfilter">Любой</label>
            													<div class="mfilter-tb-as-td mfilter-col-count"></div>
            												</div>
            											...
            											<?php foreach( $filter['options'] as $option_id => $option ) { if( $option['name'] === '' || isset( $options_tmp[$option['key']] ) ) continue; $options_tmp[$option['key']] = true; ?>
            												<?php echo $_position == 'content_top' ? '<div class="mfilter-tb">' : ''; ?>
            												<div class="mfilter-option mfilter-option-collapsed mfilter-tb-as-tr">
            													<div class="mfilter-tb-as-td mfilter-col-input">
            														<input
            															id="mfilter-opts-attribs-<?php echo (int) $_idx; ?>-<?php echo $base_id; ?>-<?php echo $option['key']; ?>"
            															name="<?php echo $filter['seo_name']; ?>"
            													...
            													<div class="mfilter-col-count" ><span class="mfilter-counter">0</span></div>
            												</div>
                                                                                                            <div class="clear"></div>
            												<?php echo $_position == 'content_top' ? '</div>' : ''; ?>
            											<?php } ?>
			...
			<li>
               <div class="mfilter-heading  mfilter-collapsed">
                   <div class="mfilter-heading-content">
                       <div class="mfilter-heading-text"><span>Отменить фильтры</span></div>
                       <i class="mfilter-head-icon"></i>
                   </div>
               </div>
               <div class="mfilter-content-opts" style="display:none" >
                   <div class="mfilter-opts-container">
                       <div class="mfilter-content-wrapper">
                           <div class="mfilter-options">
							<div class="mfilter-option mfilter-category">
								<ul class="mfilter-tb all-mf-filters" >
									<li class="mfilter-tb-as-tr main-reset">
										<div class="mfilter-tb-as-td"><?php echo $buttons['bottom']; ?></div>
									</li>
								</ul>
                           </div>
                       </div>
...
<script type="text/javascript">
            ...
            jQuery().ready(function(){
                ...
                $( "#amount" ).val( $( "#mfilter-price-slider" ).slider( "values", 0 ) + " руб. - " + $( "#mfilter-price-slider" ).slider( "values", 1 ) + " руб." );
                
                /*$(document).on('click', function(e) {
                  if (!$(e.target).closest(".mfilter-filter-item").length) {
