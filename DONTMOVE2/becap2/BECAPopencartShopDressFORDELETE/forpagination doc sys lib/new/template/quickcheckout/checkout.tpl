<?php echo $header; ?>
<div class="wrapper">
<section class="korzina width">
    <div class="forKorzina">
        ...
        <div class="tovar"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="basketCart"><?php echo $content_top; ?>
	  ...
	  <div class="">
                <p>Укажите данные или войдите в личный кабинет, если Вы ранее регистрировались.</p>
                <?php if (!$logged && $login_module) { ?>
                <div class="right_block" id="login-box">
                      <div id="checkout">
                        <p class="bold"><?php echo $text_checkout_option; ?></p>
                        <div class="quickcheckout-content"></div>
                      </div>
                </div>
                <?php } ?>
		<?php if (!$logged) { ?>
		<div id="payment-address" class="left_blok">
		  <p class="bold"><?php echo $text_checkout_account; ?></p>
		  <div class="quickcheckout-content"></div>
		</div>
		<?php } else { ?>
