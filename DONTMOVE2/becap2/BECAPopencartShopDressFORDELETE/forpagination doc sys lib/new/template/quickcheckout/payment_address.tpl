...
<form action="#" method="post" class="formBasket">
<?php foreach ($fields as $field) { ?>
  ...
  <?php } else { ?>
	<?php if (!empty(${'field_' . $field}['display'])) { ?>
	<div<?php echo $field == 'postcode' ? ' id="payment-postcode-required"' : ''; ?> class="col-sm-6 inp_block<?php echo !empty(${'field_' . $field}['required']) ? ' required' : ''; ?>">
	  ...
	  <input type="text" name="<?php echo $field; ?>" value="<?php echo ${'field_' . $field}['default']; ?>" class="cart_inp" id="input-payment-<?php echo str_replace('_', '-', $field); ?>" placeholder="" required />
	</div>
	<?php } else { ?>
...
<div id="custom-field-payment">
  ...
  <?php if ($custom_field['location'] == 'address') { ?>
	<div class="col-sm-6 custom-field inp_block" data-sort="<?php echo $custom_field['sort_order']; ?>" id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>">
          <div class="wrap_s"><span class="name_inp"><?php echo $custom_field['name']; ?></span><div class="clear"></div></div>
