<div class="navModalSee">
    <img class="closeModalSee" src="<?php echo HTTP_THEME; ?>images/exitModal.png" alt="Закрыть" onclick="closeModal()">
    <img class="leftArrowModal modalArrow" src="<?php echo HTTP_THEME; ?>images/leftArrow.png" alt="Влево" data-id="<?=$prev['id']?>" onclick="quickSee(this)">
    <img class="rightArrowModal modalArrow" src="<?php echo HTTP_THEME; ?>images/rightArrow.png" alt="Вправо" data-id="<?=$next['id']?>" onclick="quickSee(this)">
</div>				
